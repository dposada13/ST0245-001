...
public class TestTaller4 {
    ...
    public static boolean ejercicio1(){
        int a,b,c,d;
        a = Taller4.arrayMax(new int[] {12,324,43,2,3,43,2,3,43},0);
        b = Taller4.arrayMax(new int[] {3,2,343,2,43,55,67,68,86,3,4},0);
        c = Taller4.arrayMax(new int[] {56,7,6,45,8,4,34,8,7,5,34,7,78,9},0);
        d = Taller4.arrayMax(new int[] {1,2,3,4,5,5},0);
